...
struct QuizSection: Identifiable, Codable {
    let id: String
    let title: String
    ...
    enum CodingKeys: String, CodingKey {
        case id, title, description, iconName, colorName = "color", levels
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        levels = try container.decode([QuizLevel].self, forKey: .levels)
    }
